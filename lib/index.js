 ...
 * updata time 20211112 --haike模式，30fps(外接屏幕)支持1000滚动模块300000左右文本节点较流畅运行
 ...
 */
 ...
 const RollFree = ({
   ...
   const onceShowNum = Math.floor(horizontal ? width / contextWidth : height / contextHeight) + 1;
   ...
   useEffect(() => {
     ...
     let middle = [...ends];
     if (middle.length <= onceShowNum + 1) {
       middle = [...middle, ...ends];
     }
